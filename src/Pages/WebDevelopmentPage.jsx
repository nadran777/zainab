...
import AOS from "aos";
import webImg from "../assets/images/webpage.png";
 ...
 useEffect(() => {
  ...
  const pricingPlans = [
    {
      ...
      features: ["5-Page Responsive Website", "Basic SEO Setup", "Contact Form", "Mobile Responsive", "1 Month Support"],
    },
    {
      name: "Professional",
      price: "1999",
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Performance",
      description: "Optimized for speed and efficient loading",
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-20 sm:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left" data-aos="fade-right">
              <h1 className="text-5xl sm:text-6xl font-extrabold mb-6 text-red-700 leading-tight">Building Digital Excellence</h1>
              <p className="text-gray-600 text-xl mb-8">
                Transform your online presence with our cutting-edge web development services. We create responsive, modern
            ...
            <div className="relative" data-aos="fade-left">
              <img src={webImg} alt="Web Development" className="rounded-2xl shadow-2xl w-full" />
            </div>
          </div>
        </div>
      </div>
        ...
        >
          <motion.div className="bg-white shadow-xl rounded-2xl p-8 sm:p-12 overflow-hidden">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-3xl md:text-4xl font-bold text-red-700">Our Development Services</h2>
              <motion.div
              ...
              <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
                We deliver comprehensive development solutions tailored to your business needs
              </p>
            </motion.div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-4 mb-6 border-b border-red-100 pb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-800">Frontend Development</h3>
                    <p className="text-red-600 text-sm font-medium">User Interface Excellence</p>
                  </div>
                </div>
                <ul className="space-y-4">
                  {["Responsive Design", "React Applications", "UI/UX Implementation", "Performance Optimization"].map(
                    (item, i) => (
                      <motion.li
                        key={item}
              ...
              >
                <div className="flex items-center gap-4 mb-6 border-b border-red-100 pb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-800">Backend Development</h3>
                    <p className="text-red-600 text-sm font-medium">Powerful System Architecture</p>
                  </div>
                </div>
                <ul className="space-y-4">
                  {["API Development", "Database Design", "Server Configuration", "Security Implementation"].map((item, i) => (
                    <motion.li
                      key={item}
                      className="flex items-center gap-3 text-gray-700"
                      initial={{ opacity: 0, x: -10 }}
      ...
      {/* Pricing Section */}
      {/* <div className="container mx-auto px-4 py-16">
        <h2 className="text-4xl font-bold text-center mb-16 text-red-700">Choose Your Plan</h2>
